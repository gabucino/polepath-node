(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('os'), require('tty'), require('util'), require('url'), require('http'), require('https'), require('assert'), require('stream'), require('zlib')) :
    typeof define === 'function' && define.amd ? define(['exports', 'os', 'tty', 'util', 'url', 'http', 'https', 'assert', 'stream', 'zlib'], factory) :
    (factory((global.bunnycdnNode = {}),global.os,global.tty,global.util,global.url,global.http,global.https,global.assert,global.stream,global.zlib));
}(this, (function (exports,os,tty,util,url,http,https,assert,stream,zlib) { 'use strict';
            ...
            if (value instanceof Array || value instanceof Set) {
                ...
                var _loop_1 = function (key) {
                    ...
                    if (targetType && isMap) {
                        ...
                        var metadata = storage.defaultMetadataStorage.findTypeMetadata(targetType, propertyName);
                        if (metadata) {
    ...
    */
    ...
    var ClientType;
    (function (ClientType) {
        ClientType[ClientType["API"] = 0] = "API";
        ClientType[ClientType["Storage"] = 1] = "Storage";
    })(ClientType || (ClientType = {}));

    // @format
    var Resource;
    (function (Resource) {
        Resource["PullZone"] = "pullzone";
    ...
    var Endpoint;
    (function (Endpoint) {
        Endpoint["AddHostName"] = "addhostname";
        Endpoint["SetForceSSL"] = "setforcessl";
        Endpoint["AddCertificate"] = "addcertificate";
        Endpoint["AddBlockedIP"] = "addblockedip";
        Endpoint["RemoveBlockedIP"] = "removeblockedip";
        Endpoint["LoadFreeCertificate"] = "loadfreecertificate";
        Endpoint["DeleteHostName"] = "deleteHostname";
        Endpoint["PurgeCache"] = "purgeCache";
        Endpoint["ApplyCode"] = "applyCode";
        Endpoint["Purge"] = "purge";
    })(Endpoint || (Endpoint = {}));
    ...
    var Domain;
    (function (Domain) {
        Domain["API"] = "https://bunnycdn.com/api/";
        Domain["Storage"] = "https://storage.bunnycdn.com";
    })(Domain || (Domain = {}));
    ...
    var HttpBase = /** @class */ (function () {
        function HttpBase(httpClient, clientType) {
            if (clientType === void 0) { clientType = ClientType.API; }
            this.httpClient = httpClient;
            this.clientType = clientType;
            this._baseConfig = {
                headers: {
                    AccessKey: this.clientType === ClientType.Storage
                        ? BUNNY_STORAGE_API_KEY
                        : BUNNY_API_KEY,
                },
                baseURL: this.clientType === ClientType.Storage ? Domain.Storage : Domain.API,
            };
        }
        HttpBase.prototype.fetch = function (url$$1, config) {
            return this.httpClient.get(url$$1, __assign({}, this._baseConfig, config));
        };
        HttpBase.prototype.post = function (url$$1, body, config) {
            return this.httpClient.post(url$$1, body, __assign({}, this._baseConfig, config));
        };
        HttpBase.prototype.put = function (url$$1, body, config) {
            return this.httpClient.put(url$$1, body, __assign({}, this._baseConfig, config));
        };
        HttpBase.prototype.del = function (url$$1, config) {
            return this.httpClient.delete(url$$1, __assign({}, this._baseConfig, config));
        };
        return HttpBase;
    }());
    ...
    var Billing = /** @class */ (function () {
        function Billing() {
            this.balance = -1;
            this.thisMonthCharges = -1;
            this.billingRecords = -1;
            this.monthlyChargesStorage = -1;
            this.monthlyChargesEUTraffic = -1;
            this.monthlyChargesUSTraffic = -1;
            this.monthlyChargesASIATraffic = -1;
            this.monthlyChargesSATraffic = -1;
        }
        return Billing;
    }());
    ...
    var Host = /** @class */ (function () {
        function Host() {
            ...
            this.originUrl = '';
            this.forceSSL = false;
            this.isSystemHostname = false;
            this.hasCertificate = false;
        }
        return Host;
    }());

    var PullZone = /** @class */ (function () {
        function PullZone(name, originUrl) {
            this.name = name;
            this.originUrl = originUrl;
            this.id = -1;
            this.enabled = false;
            this.hostNames = [];
            this.storageZoneId = -1;
            this.allowedReferrers = [];
            this.blockedIps = [];
            this.enableGeoZoneUS = false;
            this.enableGeoZoneEU = false;
            this.zoneSecurityEnabled = false;
            this.zoneSecurityKey = '';
            this.zoneSecurityIncludeHashRemoteIP = false;
            this.ignoreQueryStrings = false;
            this.monthlyBandwidthLimit = -1;
            this.monthlyBandwidthUsed = -1;
            this.addHostHeader = false;
            this.zoneType = -1;
            this.accessControlOriginHeaderExtensions = [];
            this.enableAccessControlOriginHeader = false;
            this.disabledCookies = false;
            this.budgetRedirectedCountries = [];
            this.blockedCountries = [];
        }
        __decorate([
            decorators_2(function () { return Host; }),
            __metadata("design:type", Array)
        ], PullZone.prototype, "hostNames", void 0);
        return PullZone;
    }());

    var Statistic = /** @class */ (function () {
        function Statistic() {
            this.totalBandwidthUsed = -1;
    ...
    // @format
    var StorageZoneFile = /** @class */ (function () {
        function StorageZoneFile() {
            this.failIndex = 0;
            this.guid = '';
        ...
        return StorageZoneFile;
    }());

    // @format

    var PullZoneClient = /** @class */ (function (_super) {
        __extends(PullZoneClient, _super);
        function PullZoneClient(httpClient) {
            return _super.call(this, httpClient) || this;
        }
        PullZoneClient.prototype.get = function (pullZoneId) {
            return __awaiter(this, void 0, void 0, function () {
                var response, response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!!pullZoneId) return [3 /*break*/, 2];
                            return [4 /*yield*/, _super.prototype.fetch.call(this, Resource.PullZone)];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, classTransformer_5(PullZone, response.data)];
                        case 2: return [4 /*yield*/, _super.prototype.fetch.call(this, Resource.PullZone + "/" + pullZoneId)];
                        case 3:
                            response = _a.sent();
                            return [2 /*return*/, classTransformer_5(PullZone, response.data)];
                    }
        ...
        PullZoneClient.prototype.create = function (pullzone) {
            return __awaiter(this, void 0, void 0, function () {
                var body, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            body = classTransformer_3(pullzone);
                            return [4 /*yield*/, _super.prototype.post.call(this, Resource.PullZone, body)];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.update = function (id, pullzone) {
            return __awaiter(this, void 0, void 0, function () {
                var body;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            body = classTransformer_3(pullzone);
                            return [4 /*yield*/, _super.prototype.post.call(this, Resource.PullZone + "/" + id, body)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.addHostname = function (pullZoneId, hostName) {
            return __awaiter(this, void 0, void 0, function () {
                var body;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, _super.prototype.post.call(this, Resource.PullZone + "/" + Endpoint.AddHostName, body)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.setForceSSL = function (pullZoneId, hostName, forceSSL) {
            if (forceSSL === void 0) { forceSSL = true; }
            return __awaiter(this, void 0, void 0, function () {
                var body;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, _super.prototype.post.call(this, Resource.PullZone + "/" + Endpoint.SetForceSSL, body)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.addCertificate = function (pullZoneId, hostName, certificate, certificateKey) {
            return __awaiter(this, void 0, void 0, function () {
                var body;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, _super.prototype.post.call(this, Resource.PullZone + "/" + Endpoint.AddCertificate, body)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.addBlockedIP = function (pullZoneId, blockedIp) {
            return __awaiter(this, void 0, void 0, function () {
                var body;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, _super.prototype.post.call(this, Resource.PullZone + "/" + Endpoint.AddBlockedIP, body)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.removeBlockedIP = function (pullZoneId, blockedIp) {
            return __awaiter(this, void 0, void 0, function () {
                var body;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, _super.prototype.post.call(this, Resource.PullZone + "/" + Endpoint.RemoveBlockedIP, body)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.loadFreeCertificate = function (hostName) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.fetch.call(this, Resource.PullZone + "/" + Endpoint.LoadFreeCertificate + "?hostname=" + hostName)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.deleteHostname = function (id, hostName) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.del.call(this, Resource.PullZone + "/" + Endpoint.DeleteHostName + "?id=" + id + "&hostname=" + hostName, undefined)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        PullZoneClient.prototype.purge = function (pullZoneId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.post.call(this, Resource.PullZone + "/" + pullZoneId + "/" + Endpoint.PurgeCache, null)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
    ...
    var StorageClient = /** @class */ (function (_super) {
        ...
        function StorageClient(httpClient) {
            return _super.call(this, httpClient, ClientType.Storage) || this;
        }
        StorageClient.prototype.get = function (storageZone) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.fetch.call(this, storageZone + "/")];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, classTransformer_5(StorageZoneFile, response.data)];
                    }
                });
            });
        };
        StorageClient.prototype.getFile = function (filePath) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.fetch.call(this, filePath)];
                        case 1:
                            response = _a.sent();
        ...
        StorageClient.prototype.update = function (filePath, fileContents) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.put.call(this, filePath, fileContents, {
        ...
        StorageClient.prototype.delete = function (filePath) {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.del.call(this, filePath)];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, response.data];
                    }
    ...
    var Bunny = /** @class */ (function (_super) {
        ...
        function Bunny(httpClient) {
            var _this = _super.call(this, httpClient || axios$1) || this;
            _this._pullZoneClient = new PullZoneClient(httpClient || axios$1);
            _this._storageClient = new StorageClient(httpClient || axios$1);
            return _this;
        }
        Object.defineProperty(Bunny.prototype, "pullZone", {
            get: function () {
        ...
        Object.defineProperty(Bunny.prototype, "storage", {
            get: function () {
        ...
        Bunny.prototype.statistics = function () {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.fetch.call(this, Resource.Statistic)];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, classTransformer_5(Statistic, response.data)];
                    }
                });
            });
        };
        Bunny.prototype.billing = function () {
            return __awaiter(this, void 0, void 0, function () {
                var response;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.fetch.call(this, Resource.Billing)];
                        case 1:
                            response = _a.sent();
                            return [2 /*return*/, classTransformer_5(Billing, response.data)];
                    }
                });
            });
        };
        Bunny.prototype.applyCode = function (couponCode) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.fetch.call(this, Resource.Billing + "/" + Endpoint.ApplyCode + "?" + Parameter.CouponCode + "=" + couponCode)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        Bunny.prototype.purge = function (url$$1) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, _super.prototype.post.call(this, Endpoint.Purge + "?" + Parameter.URL + "=" + url$$1, null)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        Bunny.prototype.hardUpdate = function (host, storageZone, path, fileName, fileContents) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.storage.update(storageZone + "/" + path + "/" + fileName, fileContents)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, this.purge(host + "/" + path + "/" + fileName)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/];
                    }
...
//# sourceMappingURL=bunnycdn-node.umd.js.map
